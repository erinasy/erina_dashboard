    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/profile">
              <i class="bi bi-circle"></i><span>Profil Kami</span>
            </a>
          </li>
          <li>
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-editors.html">
              <i class="bi bi-circle"></i><span>Form Booking</span>
            </a>
          </li>
          <li>
            <a href="customers/create">
              <i class="bi bi-circle"></i><span>Form Customers</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="typeKamar">
              <i class="bi bi-circle"></i><span>Data Type Kamar</span>
            </a>
          </li>
          <li>
            <a href="fasilitas">
